...
class Portal_scroll_restore_displayOnOff extends React.Component {
  constructor() {
    super();
    ...
    console.log('render!!')
        return (
            <div className="App">
              ...
              {this.renderPanel()}
              <div style={{
                display : this.state.tab === 'online' ? 'block' : 'none'
              }}>
              <InfiniteLoader
              ...
              <div style={{
                display : this.state.tab === 'goods' ? 'block' : 'none'
              }}>
              <InfiniteLoader
                    // isRowLoaded={this.isRowLoaded}
                    // loadMoreRows={this.loadMoreRows}
...
export default Portal_scroll_restore_displayOnOff;